...
def lineage_coordinator_agent(state: LineageState):
    ...
    Analysis Rules:
    - If query mentions specific element names and keywords like "element", "column", "data element", "field" from available elements -> element_based
...
class LineageOrchestrator:
    ...
    def _build_workflow(self):
        ...
        db = SqliteSaver.from_conn_string(":memory:")
        ...
        return workflow.compile(interrupt_before=["human_approval"], checkpointer=db)
